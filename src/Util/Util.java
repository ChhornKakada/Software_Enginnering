...
public class Util {
  ...
  public static Integer getIntWithTryCatch(String errorInput) {
    Integer number = null;
    while (true) {
      try {
  ...
  public static int getOnly1or2(String errorInput) {
    ...
    if (temp != 1 && temp != 2) {
      System.out.print(errorInput);
      temp = Util.getOnly1or2(errorInput);
    }
    return temp;
  }
  ...
  // get positive double
  public static double getPositiveDouble(String errorInput) {
    double number = Util.getDouble(errorInput);
    if (number < 0) {
      System.out.println(errorInput);
      number = getPositiveDouble(errorInput);
    }
    return number;
  }
